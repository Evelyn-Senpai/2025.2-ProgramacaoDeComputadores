...
try:
    ...
    horas = int(input('Quantas horas você trabalhou na semana? '))
    ...
    sys.exit(print('ERRO: Digite um número inteiro!'))
    ...
    if horas > 40:
        ...
        adicional = salario*1.5
        print(f'Seu salário é {salario+adicional:.2f}')
    else:
